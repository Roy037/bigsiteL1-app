...
@section('content')
    ...
    <form action="/cars/{{ $car->id }}" method="post">
        ...
        <input class="form-control" type="file" name="image" {{ $car->image_path }}>
        <input class="form-control" type="text" name="name" {{ $car->name }} placeholder="enter cars name">
        <input class="form-control" type="text" name="description" {{ $car->description }} placeholder="enter cars description">
